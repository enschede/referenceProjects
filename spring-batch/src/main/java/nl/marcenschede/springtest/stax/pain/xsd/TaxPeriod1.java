...
@XmlType(name = "TaxPeriod1", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02", propOrder = {
    "yr",
    "tp",
    "frToDt"
})
public class TaxPeriod1 {
    ...
    @XmlElement(name = "Yr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    ...
    @XmlElement(name = "FrToDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
