...
@XmlType(name = "PaymentTypeInformation20", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02", propOrder = {
    "instrPrty",
    "svcLvl",
    "lclInstrm",
    "seqTp",
...
public class PaymentTypeInformation20 {
    ...
    @XmlElement(name = "InstrPrty", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    @XmlSchemaType(name = "string")
    protected Priority2Code instrPrty;
    @XmlElement(name = "SvcLvl", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    protected ServiceLevel8Choice svcLvl;
    @XmlElement(name = "LclInstrm", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    protected LocalInstrument2Choice lclInstrm;
    @XmlElement(name = "SeqTp", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    @XmlSchemaType(name = "string")
