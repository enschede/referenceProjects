...
@XmlType(name = "DirectDebitTransaction6", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02", propOrder = {
    "mndtRltdInf",
    "cdtrSchmeId",
    "preNtfctnId",
    "preNtfctnDt"
...
public class DirectDebitTransaction6 {
    ...
    @XmlElement(name = "MndtRltdInf", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    ...
    @XmlElement(name = "PreNtfctnId", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    protected String preNtfctnId;
    @XmlElement(name = "PreNtfctnDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
