...
@XmlType(name = "MandateRelatedInformation6", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02", propOrder = {
    "mndtId",
    "dtOfSgntr",
    "amdmntInd",
    "amdmntInfDtls",
...
public class MandateRelatedInformation6 {
    ...
    @XmlElement(name = "MndtId", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    protected String mndtId;
    @XmlElement(name = "DtOfSgntr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    ...
    @XmlElement(name = "FrstColltnDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar frstColltnDt;
    @XmlElement(name = "FnlColltnDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar fnlColltnDt;
    @XmlElement(name = "Frqcy", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
