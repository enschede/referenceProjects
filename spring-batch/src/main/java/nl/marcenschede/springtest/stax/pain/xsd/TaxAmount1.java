...
@XmlType(name = "TaxAmount1", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02", propOrder = {
    "rate",
    "taxblBaseAmt",
    "ttlAmt",
    "dtls"
...
public class TaxAmount1 {
    ...
    @XmlElement(name = "Rate", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    protected BigDecimal rate;
    @XmlElement(name = "TaxblBaseAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    protected ActiveOrHistoricCurrencyAndAmount taxblBaseAmt;
    @XmlElement(name = "TtlAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    protected ActiveOrHistoricCurrencyAndAmount ttlAmt;
    @XmlElement(name = "Dtls", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
