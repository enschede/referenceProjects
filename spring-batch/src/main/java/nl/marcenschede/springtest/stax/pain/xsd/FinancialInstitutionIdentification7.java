...
@XmlType(name = "FinancialInstitutionIdentification7", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02", propOrder = {
    "bic",
    "clrSysMmbId",
    "nm",
    "pstlAdr",
...
public class FinancialInstitutionIdentification7 {
    ...
    @XmlElement(name = "ClrSysMmbId", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
