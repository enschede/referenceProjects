...
@XmlType(name = "NameAndAddress10", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02", propOrder = {
    "nm",
    "adr"
})
public class NameAndAddress10 {

    @XmlElement(name = "Nm", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02", required = true)
    protected String nm;
    @XmlElement(name = "Adr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02", required = true)
