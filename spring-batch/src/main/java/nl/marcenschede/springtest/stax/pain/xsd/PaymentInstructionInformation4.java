...
@XmlType(name = "PaymentInstructionInformation4", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02", propOrder = {
    "pmtInfId",
    "pmtMtd",
    "btchBookg",
    "nbOfTxs",
...
public class PaymentInstructionInformation4 {
    ...
    @XmlElement(name = "CdtrAgtAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    ...
    @XmlElement(name = "ChrgsAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    protected CashAccount16 chrgsAcct;
    @XmlElement(name = "ChrgsAcctAgt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
