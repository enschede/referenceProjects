...
@XmlType(name = "AmendmentInformationDetails6", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02", propOrder = {
    "orgnlMndtId",
    "orgnlCdtrSchmeId",
    "orgnlCdtrAgt",
    "orgnlCdtrAgtAcct",
...
public class AmendmentInformationDetails6 {
    ...
    @XmlElement(name = "OrgnlCdtrAgt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    protected BranchAndFinancialInstitutionIdentification4 orgnlCdtrAgt;
    @XmlElement(name = "OrgnlCdtrAgtAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    protected CashAccount16 orgnlCdtrAgtAcct;
    @XmlElement(name = "OrgnlDbtr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    ...
    @XmlElement(name = "OrgnlDbtrAgtAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    protected CashAccount16 orgnlDbtrAgtAcct;
    @XmlElement(name = "OrgnlFnlColltnDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar orgnlFnlColltnDt;
    @XmlElement(name = "OrgnlFrqcy", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02")
